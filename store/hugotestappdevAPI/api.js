...
function modules_drive_service_file_list_retrieve(payload) {
  return hugotestappdevAPI.get(`/modules/drive/service/file/list/`)
}
function modules_drive_service_share_file_create(payload) {
  return hugotestappdevAPI.post(`/modules/drive/service/share/file/`, payload)
}
function modules_drive_service_upload_file_create(payload) {
  return hugotestappdevAPI.post(`/modules/drive/service/upload/file/`, payload)
}
