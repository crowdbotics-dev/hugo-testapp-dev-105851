...
function modules_hubspot_service_deals_associations_create_create(payload) {
  return hugotestappdevAPI.post(`/modules/hubspot/service/deals/associations/create/`);
}
...
function modules_hubspot_service_meeting_contacts_list_retrieve(payload) {
  return hugotestappdevAPI.get(`/modules/hubspot/service/meeting/contacts/list/`);
}

function modules_hubspot_service_ticket_associations_create_update(payload) {
  return hugotestappdevAPI.put(`/modules/hubspot/service/ticket/associations/create/`);
}

function modules_hubspot_service_ticket_associations_list_retrieve(payload) {
  return hugotestappdevAPI.get(`/modules/hubspot/service/ticket/associations/list/`);
}
