"""
Django settings for hugo_testapp_dev_105851 project.
...
ROOT_URLCONF = 'hugo_testapp_dev_105851.urls'
...
WSGI_APPLICATION = 'hugo_testapp_dev_105851.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hugo_testapp_dev_105851 API",
    "DESCRIPTION": "API documentation for hugo_testapp_dev_105851 App",
    "VERSION": "v1",
}
